...
echo "Starting Garmin Viz Dashboard setup..."
...
echo "🐳 Building the garmin-fetch-data Docker image..."
docker compose build || { echo "Docker build failed. Do you have docker installed and can run docker commands?"; exit 1; }
